...
const MyProfile = () =>{
    ...
    const getInfo = () =>{
        var url = "https://eduprovapiserver.app.vtxhub.com/fetchemployeeinfo";
    ...
    const save = () =>{
        ...
        var url = "https://eduprovapiserver.app.vtxhub.com/attendance";
        axios.post(url, input)
        .then(response =>{
    ...
    const LunchIn = () =>{
        ...
        var url = "https://eduprovapiserver.app.vtxhub.com/lunchbreakin";
        axios.post(url, input)
        .then(response =>{
            updateMessage(response.data);
        })
    ...
    const LunchOut = () =>{
        ...
        var input = {"ename":name, "econtact":contact, "ecardid":cardid, "edate":dt, "etime":displaytime, "empid":empid};
        // var input = {"etime":displaytime, "elunchout":lunchout, "elunchbreakout":lunchbreakout, "empid":empid}
        var url = "https://eduprovapiserver.app.vtxhub.com/lunchbreakout";
        axios.post(url, input)
        .then(response =>{
            updateMessage(response.data);
        })
    ...
    const LogOut = () =>{
        ...
        var input = {"ename":name, "econtact":contact, "ecardid":cardid, "edate":dt, "etime":displaytime, "empid":empid};
        // var input = {"etime":displaytime, "elunchout":lunchout, "elunchbreakout":lunchbreakout, "empid":empid}
        var url = "https://eduprovapiserver.app.vtxhub.com/logout";
        axios.post(url, input)
        .then(response =>{
            updateMessage(response.data);
        })
